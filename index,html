...
<head>
 ...
 <title>Вакансия: рабочий по демонтажу — оплата 4000 руб./смена</title>
...
<body>
 ...
 <p>На постоянную работу требуется рабочий для выполнения демонтажных работ. Работа физически тяжелая, но с хорошей оплатой и ежедневными авансами.</p>
